...
public class Adjoint3by3page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adjoint3by3page);

        eta11 = (EditText)findViewById(R.id.etadj33a11);
        eta12 = (EditText)findViewById(R.id.etadj33a12);
        eta13 = (EditText)findViewById(R.id.etadj33a13);
        eta21 = (EditText)findViewById(R.id.etadj33a21);
        eta22 = (EditText)findViewById(R.id.etadj33a22);
        eta23 = (EditText)findViewById(R.id.etadj33a23);
        eta31 = (EditText)findViewById(R.id.etadj33a31);
        eta32 = (EditText)findViewById(R.id.etadj33a32);
        eta33 = (EditText)findViewById(R.id.etadj33a33);
        reult = (Button)findViewById(R.id.btadj3by3result);
        answer = (TextView)findViewById(R.id.tvadj3by3reault);
