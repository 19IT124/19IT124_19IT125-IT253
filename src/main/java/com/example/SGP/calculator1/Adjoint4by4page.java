...
public class Adjoint4by4page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adjoint4by4page);

        eta11 = (EditText)findViewById(R.id.etadj44a11);
        eta12 = (EditText)findViewById(R.id.etadj44a12);
        eta13 = (EditText)findViewById(R.id.etadj44a13);
        eta14 = (EditText)findViewById(R.id.etadj44a14);
        eta21 = (EditText)findViewById(R.id.etadj44a21);
        eta22 = (EditText)findViewById(R.id.etadj44a22);
        eta23 = (EditText)findViewById(R.id.etadj44a23);
        eta24 = (EditText)findViewById(R.id.etadj44a24);
        eta31 = (EditText)findViewById(R.id.etadj44a31);
        eta32 = (EditText)findViewById(R.id.etadj44a32);
        eta33 = (EditText)findViewById(R.id.etadj44a33);
        eta34 = (EditText)findViewById(R.id.etadj44a34);
        eta41 = (EditText)findViewById(R.id.etadj44a41);
        eta42 = (EditText)findViewById(R.id.etadj44a42);
        eta43 = (EditText)findViewById(R.id.etadj44a43);
        eta44 = (EditText)findViewById(R.id.etadj44a44);
        result = (Button)findViewById(R.id.btadj4by4result);
        answer = (TextView)findViewById(R.id.tvadj4by4result);
