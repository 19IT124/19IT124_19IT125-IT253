package com.example.SGP.calculator1;
...
public class Transpose4by4page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transpose4by4page);

        eta11 = (EditText)findViewById(R.id.ettra44a11);
        eta12 = (EditText)findViewById(R.id.ettra44a12);
        eta13 = (EditText)findViewById(R.id.ettra44a13);
        eta14 = (EditText)findViewById(R.id.ettra44a14);
        eta21 = (EditText)findViewById(R.id.ettra44a21);
        eta22 = (EditText)findViewById(R.id.ettra44a22);
        eta23 = (EditText)findViewById(R.id.ettra44a23);
        eta24 = (EditText)findViewById(R.id.ettra44a24);
        eta31 = (EditText)findViewById(R.id.ettra44a31);
        eta32 = (EditText)findViewById(R.id.ettra44a32);
        eta33 = (EditText)findViewById(R.id.ettra44a33);
        eta34 = (EditText)findViewById(R.id.ettra44a34);
        eta41 = (EditText)findViewById(R.id.ettra44a41);
        eta42 = (EditText)findViewById(R.id.ettra44a42);
        eta43 = (EditText)findViewById(R.id.ettra44a43);
        eta44 = (EditText)findViewById(R.id.ettra44a44);
        result = (Button)findViewById(R.id.bttra4by4result);
        answer = (TextView)findViewById(R.id.tvtra4by4result);
        ...
        result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             /*   double sum = 0 ;
                ...
                answer.setText(""+t.format(c11)+"     "+t.format(c21)+"     "+t.format(c31)+"     "+t.format(c41)+"\n"+t.format(c12)+"     "+t.format(c22)+"     "+t.format(c32)+"     "+t.format(c42)+"\n"+t.format(c13)+"     "+t.format(c23)+"     "+t.format(c33)+"     "+t.format(c43)+"\n"+t.format(c14)+"     "+t.format(c24)+"     "+t.format(c34)+"     "+t.format(c44));
